...
const MainPageContent = () => {
  ...
  const features = [
    {
      title: "EDZÉSTERVEK",
      description: "Professzionális személyi edzők által tervezett, AI-alapú programok.",
    ...
    {
      title: "ÉTRENDTERVEK",
      description: "Táplálkozási szakértők által optimalizált étrendek, testtípus szerint.",
        ...
        >
          <Box sx={{
            ...
            <Typography variant="subtitle1" fontWeight={700} sx={{ display: 'flex', alignItems: 'center' }}>
              {userName} <Diamond sx={{ color: '#fff', ml: 1, fontSize: '1rem' }} />
            </Typography>
            <Typography variant="caption">TAG</Typography>
          </Box>
          <Divider sx={{ borderColor: 'rgba(212, 175, 55, 0.3)' }} />
          <MenuItem component={Link} to="/mainPage/profil" onClick={handleMenuClose}>
            <ListItemIcon sx={{ color: '#d4af37' }}><AccountCircle /></ListItemIcon>
            <ListItemText>Profil</ListItemText>
          </MenuItem>
          <MenuItem component={Link} to="/mainPage/settings" onClick={handleMenuClose}>
            <ListItemIcon sx={{ color: '#d4af37' }}><Settings /></ListItemIcon>
                ...
                <Grow in timeout={800 + (i * 200)}>
                  ...
                  >
                    <Card sx={{
                      ...
                      <Box className="card-hover-effect" sx={{
                        position: 'absolute',
                        top: 0,
                        left: '-100%',
                        width: '60%',
